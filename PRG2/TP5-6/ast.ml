...
(* op2string : operateur -> string
   Donne la chaine de caract�re correspondant � l'op�rateur
*)
...
(* expr2string : (e: expression) -> string
   Donne la chaine de caract�re repr�sentant l'expression e *)
...
(* formule2string : (f: formule) -> string
   Donne la chaine repr�sentant la formule f
*)
...
(* programme2string: (p: programme) -> string
   Donne la cha�ne de caract�re correspondant au programme p *)
