...
public class TpListe {
	...
	private final static String[] COMMAND_TEXTS = {
			"afficher les entiers appartenant � l'ensemble num�ro n1",
			"afficher les rangs pr�sents dans l'ensemble num�ro n1",
			"ajouter des valeurs � l'ensemble num�ro n1",
			"d�terminer si x appartient � l'ensemble num�ro n1",
			"afficher le cardinal de l'ensemble num�ro n1",
			"l'ensemble num�ro n1 <-- diff�rence l'ensemble num�ro n1 \\ l'ensemble num�ro n2)",
			"l'ensemble num�ro n1 <-- diff�rence sym�trique de l'ensemble num�ro n1 et l'ensemble num�ro n2",
			"d�terminer si l'ensemble num�ro n1 et l'ensemble num�ro n2 sont �gaux",
			"d�terminer si l'ensemble num�ro n1 est inclus dans l'ensemble num�ro n2",
			"l'ensemble num�ro n1 <-- intersection de l'ensemble num�ro n1 et l'ensemble num�ro n2",
			"r�initialiser l'ensemble num�ro n1 � partir d'un fichier",
			"retirer des valeurs � l'ensemble num�ro n1",
			"sauvegarder l'ensemble num�ro n1 dans un fichier",
			"l'ensemble num�ro n1 <-- union de l'ensemble num�ro n1 et l'ensemble num�ro n2",
			"arr�t de l'ex�cution" };

	private final static String[] ITEM_NAMES = { "AfficherEns",
			"AfficherRangs", "Ajouter", "Appartient", "Cardinal", "Diff�rence",
			"Diff�renceSym�trique", "Egaux", "Inclus", "Intersection",
			"R�initialiser", "Retirer", "Sauvegarder", "Union", "Quitter" };
	...
	private static void execute(int i) { // traitements associ�s aux boutons
	...
	private static int readSetNumber(int i) {
		...
		do {
			b = true;
			number = 0;
			System.out.print("  num�ro d'ensemble n" + i + " (>=0 et <"
					+ MAX_SET + ") : ");
			try {
