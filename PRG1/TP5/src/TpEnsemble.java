...
public class TpEnsemble {
    ...
    private static void executer(int i) { // traitements associ? aux boutons
	...
	return lireEnt("  num?o d'ensemble n" + i + " : ", 0, MAXENS - 1);
    }
