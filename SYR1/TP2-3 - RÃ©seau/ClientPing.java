...
public class ClientPing {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Statistiques: Max = " + max + "ms, Min = " + min + "ms, Moyenne = " + average + "ms, Paquets reçus = " + nb_receive + " paquets, Paquets perdus = " + (NB_PAQUETS-nb_receive) + " paquets.");
